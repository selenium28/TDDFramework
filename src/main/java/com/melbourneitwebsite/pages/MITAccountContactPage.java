...
public class MITAccountContactPage extends TestBase{
   ...
   public MITRegistrantContactPage clickContinueButton(){
    	...
    	return new MITRegistrantContactPage();
    }
   
   public MITRegistrantContactPage clickLoginButton(){
