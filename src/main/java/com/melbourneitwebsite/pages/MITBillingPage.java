...
public class MITBillingPage extends TestBase{
    ...
    public void setQuestFormCreditCardDetails(String cardowner, String cardtype, String cardnumber, String cardexpirymonth, String cardexpiryyear, String cardsecuritycode){
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[1]/td[2]/input[@name='billing.owner']")).sendKeys(cardowner);
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[2]/td[2]/select[@name='billing.type']")).sendKeys(cardtype);
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[3]/td[2]/input[@name='billing.digits']")).sendKeys(cardnumber);
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[4]/td[2]/select[@name='billing.expiryMonth']")).sendKeys(cardexpirymonth);
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[4]/td[2]/select[@name='billing.expiryYear']")).sendKeys(cardexpiryyear);
    	driver.findElement(By.xpath("//div[@id='creditCardFormAud']/table/tbody/tr[5]/td[2]/input[@name='billing.cvv']")).sendKeys(cardsecuritycode);   
    }
