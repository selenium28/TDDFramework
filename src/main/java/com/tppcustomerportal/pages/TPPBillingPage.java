...
public class TPPBillingPage extends TestBase{
    ...
    public TPPOrderCompletePage clickContinueButton(){
       	...
       	return new TPPOrderCompletePage();
    }
	...
	public TPPOrderCompletePage clickPlaceYourOrder(){
