...
public class RegressionSalesDB extends TestBase{
		...
		public String strVirtualization = "WebCentral";
...
//					strCardExpiryYear = "20";
				...
				Assert.assertEquals(cataxinvoicepage.getInvoicePaymentConfirmation(), "The payment of AU$267.95 for invoice "+strInvoiceNumber+" has been accepted");
