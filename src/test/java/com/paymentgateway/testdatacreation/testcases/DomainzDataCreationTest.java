...
public class DomainzDataCreationTest extends TestBase{
	...
	public void generateCustomerDataWithMonthlyBillingProduct(String environment, Integer iteration) throws InterruptedException, AWTException{
		...
		if (intMinCount == 4) {
			...
			strCardOwnerName = "Domainz New Customer - Monthly Product 40050004";
			strCardType = "Visa";
			strCardNumber = "4005519200000004";
		    strCardExpiryMonth = "02";
		    strCardExpiryYear = "2022";
			...
			strCardOwnerName = "Domainz New Customer - Monthly Product 45000061";
			strCardType = "Visa";
			...
			strCardOwnerName = "Domainz New Customer - Monthly Product 40120026";
			strCardType = "Visa";
			strCardNumber = "4012000033330026";
		    strCardExpiryMonth = "04";
		    strCardExpiryYear = "2022";
		...
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz Returning Customer - Monthly Product 55554444";
			strCardType = "MasterCard";
			strCardNumber = "5555555555554444";
		    strCardExpiryMonth = "05";
		    strCardExpiryYear = "2022";
			...
			strCardOwnerName = "Domainz Returning Customer - Monthly Product 22230014";
			strCardType = "MasterCard";
			strCardNumber = "2223520043560014";
		    strCardExpiryMonth = "06";
		    strCardExpiryYear = "2022";
			...
			strCardOwnerName = "Domainz Returning Customer - Monthly Product 54545454";
			strCardType = "MasterCard";
			strCardNumber = "5454545454545454";
		    strCardExpiryMonth = "07";
		    strCardExpiryYear = "2022";
			...
			strCardOwnerName = "Domainz Returning Customer - Monthly Product 22230011";
			strCardType = "MasterCard";
			strCardNumber = "2223000048400011";
		    strCardExpiryMonth = "08";
		    strCardExpiryYear = "2022";
	...
	public void generateCustomerDataWithYearlyBillingProduct(String environment, Integer iteration) throws InterruptedException, AWTException{
		...
		//Test Step 2: Input credit card details and submit the order 
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz New Customer - Yearly Product 40127777";
			strCardType = "Visa";
			...
			strCardOwnerName = "Domainz New Customer - Yearly Product 42171119";
			strCardType = "Visa";
			...
			strCardOwnerName = "Domainz New Customer - Yearly Product 41111111";
			strCardType = "Visa";
			strCardNumber = "4111111111111111";
		    strCardExpiryMonth = "03";
		    strCardExpiryYear = "2023";
			...
			strCardOwnerName = "Domainz New Customer - Yearly Product 40121881";
			strCardType = "Visa";
		...
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz Returning Customer - Yearly Product 22230011";
			strCardType = "MasterCard";
			strCardNumber = "2223000048400011";
		    strCardExpiryMonth = "05";
		    strCardExpiryYear = "2023";
			...
			strCardOwnerName = "Domainz Returning Customer - Yearly Product 55554444";
			strCardType = "MasterCard";
			strCardNumber = "5555555555554444";
		    strCardExpiryMonth = "06";
		    strCardExpiryYear = "2023";
			...
			strCardOwnerName = "Domainz Returning Customer - Yearly Product 22230014";
			strCardType = "MasterCard";
			strCardNumber = "2223520043560014";
		    strCardExpiryMonth = "07";
		    strCardExpiryYear = "2023";
			...
			strCardOwnerName = "Domainz Returning Customer - Yearly Product 54545454";
			strCardType = "MasterCard";
			strCardNumber = "5454545454545454";
		    strCardExpiryMonth = "08";
		    strCardExpiryYear = "2023";
	...
	public void generateCustomerDataWithOutstandingInvoice(String environment, Integer iteration) throws InterruptedException, AWTException{
		...
		//Test Step 2: Input credit card details and submit the order 
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz New Customer - With Outstanding Invoice 42171119";
			strCardType = "Visa";
			strCardNumber = "4217651111111119";
			...
			strCardOwnerName = "Domainz New Customer - With Outstanding Invoice 40091881";
			strCardType = "Visa";
			strCardNumber = "4009348888881881";
			...
			strCardOwnerName = "Domainz New Customer - With Outstanding Invoice 40121881";
			strCardType = "Visa";
			strCardNumber = "4012888888881881";
			...
			strCardOwnerName = "Domainz New Customer - With Outstanding Invoice 45000061";
			strCardType = "Visa";
			strCardNumber = "4500600000000061";
	...
	public void generateCustomerDataWithDefaultCreditCard(String environment, Integer iteration) throws InterruptedException, AWTException{
		...
		//Test Step 2: Input credit card details and submit the order 
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz New Customer 41111111";
			strCardType = "Visa";
			strCardNumber = "4111111111111111";
		    strCardExpiryMonth = "01";
			...
			strCardOwnerName = "Domainz New Customer 40091881";
			strCardType = "Visa";
			strCardNumber = "4009348888881881";
		    strCardExpiryMonth = "02";
		    strCardExpiryYear = "2025";
			...
			strCardOwnerName = "Domainz New Customer 54545454";
			strCardType = "MasterCard";
			strCardNumber = "5454545454545454";
		    strCardExpiryMonth = "03";
		    strCardExpiryYear = "2025";
			...
			strCardOwnerName = "Domainz New Customer 22230011";
			strCardType = "MasterCard";
			strCardNumber = "2223000048400011";
		    strCardExpiryMonth = "04";
		    strCardExpiryYear = "2025";
		...
		if (intMinCount == 4) {
			strCardOwnerName = "Domainz Returning Customer - Default Credit Card 55554444";
			strCardType = "MasterCard";
			strCardNumber = "5555555555554444";
		    strCardExpiryMonth = "05";
		    strCardExpiryYear = "2025";
			...
			strCardOwnerName = "Domainz Returning Customer - Default Credit Card 22230014";
			strCardType = "MasterCard";
			strCardNumber = "2223520043560014";
		    strCardExpiryMonth = "06";
		    strCardExpiryYear = "2025";
			...
			strCardOwnerName = "Domainz Returning Customer - Default Credit Card 40127777";
			strCardType = "Visa";
			strCardNumber = "4012000077777777";
		    strCardExpiryMonth = "07";
		    strCardExpiryYear = "2025";
			...
			strCardOwnerName = "Domainz Returning Customer - Default Credit Card 40050004";
			strCardType = "Visa";
			strCardNumber = "4005519200000004";
		    strCardExpiryMonth = "08";
		    strCardExpiryYear = "2025";
