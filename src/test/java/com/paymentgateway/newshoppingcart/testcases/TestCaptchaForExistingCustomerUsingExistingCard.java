...
public class TestCaptchaForExistingCustomerUsingExistingCard extends TestBase{
	...
	public TestCaptchaForExistingCustomerUsingExistingCard() {
		super();
	}
	...
	@Test
	public void testCaptchaForExistingCustomerUsingExistingCard (String environment, Integer iteration) throws InterruptedException{
